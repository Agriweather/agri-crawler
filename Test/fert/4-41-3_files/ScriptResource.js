...
"argumentDomElement":"值必須是 DOM 項目。",
...
"behaviorDuplicateName":"已經有名為 \u0027{0}\u0027 的行為，或者它是目標項目上的現有屬性。",
"notATypeName":"值不是有效的型別名稱。",
"elementNotFound":"找不到 ID 為 \u0027{0}\u0027 的項目。",
"stateMustBeStringDictionary":"此狀態物件只能有 null 和字串欄位。",
"boolTrueOrFalse":"值必須是 \u0027true\u0027 或 \u0027false\u0027。",
"scriptLoadFailedNoHead":"ScriptLoader 需要頁面來包含 \u003chead\u003e 項目。",
...
"controlAlreadyDefined":"已經有控制項與此項目關聯。",
...
"historyMissingFrame":"如果要讓記錄功能在 IE 中運作，此頁面必須有 ID 為 \u0027__historyFrame\u0027 的 iFrame 項目，指向從 \u0027title\u0027 查詢字串參數取得標題並且在父視窗上呼叫 Sys.Application._onIFrameLoad() 的頁面。在 ScriptManager 上將 EnableHistory 設定為 true 即可完成此動作。",
...
"baseNotAClass":"值不是類別。",
"expectedElementOrId":"值必須是 DOM 項目或 DOM 項目 ID。",
...
"argumentDomNode":"值必須是 DOM 項目或文字節點。",
